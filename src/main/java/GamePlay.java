...
public class GamePlay implements GamePlayInterface {
    ...
    public boolean levelUp(Character character) {
        ...
        if (character.experience >= character.pointsPerLevel) {
            ...
            // SER316 TASK 2 SPOTBUGS FIX
            if (character.getClass().getName().equals(BARBARIAN_NAME)) {
                character.damage += 10;
                ...
                test = true;
            // SER316 TASK 2 SPOTBUGS FIX
            } else if (character.getClass().getName().equals(BARD_NAME)) {
                ...
                test = true;
            // SER316 TASK 2 SPOTBUGS FIX
            } else if (character.getClass().getName().equals(DRUID_NAME)) {
                character.damage += 10;
                ...
                test = true;
            // SER316 TASK 2 SPOTBUGS FIX
            } else if (character.getClass().getName().equals(RANGER_NAME)) {
                ...
                test = true;
            // SER316 TASK 2 SPOTBUGS FIX
            } else if (character.getClass().getName().equals(ROGUE_NAME)) {
                ...
                test = true;
            // SER316 TASK 2 SPOTBUGS FIX
            } else if (character.getClass().getName().equals(WIZARD_NAME)) {
                character.damage += 5;
                character.speed += 1;
